    ...
    <section class="parallax-window" data-parallax="scroll" data-image-src="img/about_bg.jpg" data-natural-width="1400" data-natural-height="470">
        <div class="parallax-content-1">
            <div class="animated fadeInDown">
                ...
                <p>We offer many types of rental Vehicles in Pakistan for tour travel here.</p>
            </div>
        </div>
    </section>
    <!-- End Section -->
                        ...
                        <div class="collapse show" id="collapseFilters">
                            ...
                            <div class="filter_type">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label>
                                            <input type="checkbox">Heated Sets
                                        </label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox">Chilled Seats
                                        </label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox">Entertainment system
                                        </label>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_car.html"><img src="img/cars/Toyota_HiAce_GL_Grandia_Tourer_van_front.jpg" alt="Image">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="tour_list_desc">
                                    ...
                                    <h3><strong>Toyota Hiace</strong> High Roof</h3>
                                    <p>you can now book the best Vehicles.</p>
                                    <ul class="add_info">
                                        <li>
                                            <a href="javascript:void(0);" class="tooltip-1" data-placement="top" title="Free Wifi"><i class="icon_set_1_icon-86"></i></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" class="tooltip-1" data-placement="top" title="Heated Seats"><i class="icon_set_2_icon-115"></i></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" class="tooltip-1" data-placement="top" title="Chilled Seats"><i class="icon_set_2_icon-110"></i></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" class="tooltip-1" data-placement="top" title="Entertainment System"><i class="icon_set_2_icon-116"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <div class="price_list">
                                    <div>1500*<span class="normal_price_list">2500</span><small>*Per Day</small>
                                        <p><a href="single_car.html" class="btn_1">Details</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_car.html"><img src="img/cars/2017_Honda_Civic_SR_VTEC_1.0_Front.jpg" alt="Image">
                                        <div class="short_info"></div>
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="tour_list_desc">
                                    ...
                                    <h3><strong>Honda Civic</strong> Sedan</h3>
                                    <p>you can now book the best Vehicles.</p>
                                    <ul class="add_info">
                                        <li>
                                            <a href="javascript:void(0);" class="tooltip-1" data-placement="top" title="Free Wifi"><i class="icon_set_1_icon-86"></i></a>
                            ...
                            <div class="col-lg-2 col-md-2">
                                <div class="price_list">
                                    <div>2500*<span class="normal_price_list">5500</span><small>*Per Day</small>
                                        <p><a href="single_car.html" class="btn_1">Details</a>
                                        </p>
                                    </div>
                                </div>
